	...
	return (
		<div className="flex flex-row items-start justify-between">
			<div className="flex items-center gap-x-2">
				...
				<p className="text-sm md:text-md text-neutral-600">+995 551 721 313</p>
			</div>

			<div className="flex items-center mb-4 gap-x-2">
				<LucideInstagram size={14} className="text-neutral-600" />
				<a href="https://www.instagram.com/beerhousebatumi" className="text-sm cursor-pointer md:text-md text-neutral-600">beerhousebatumi</a>
			</div>
		</div>
	)
}
